        ...
        */
        ...
        'ShirOS' => [
            ...
            */
            ...
            |
            |   Namespace
            |       |- Repository (Chemin des Repository de l'application)
            |
            ...
            */
            ...
            |   Folder
            |       |- Namespace
            |           |- Entity    (Nom du Dossier contenant les Models/Entities)
            |           |- Repository  (Nom du Dossier contenant les Repository)
            |   File
            |       |- Namespace
            |           |- Entity    (Prefixe ou Suffixe d'un Entity/Entity)  Exemple: 'class UserModel {}'   => 'UserModel.php'
            |           |- Repository  (Prefixe ou Suffixe d'une Repository)      Exemple: 'class UserGateway {}' => 'UserGateway.php'
            |       |- Error
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            |   Permet de préciser au Framework, l'utilisation d'un préfixe ou suffixe dans le nom des Models et Repository
            |
            |   3 Choix :
